	...
	$(document).ready(function(){
		...
		if ( $('#wpb_visual_composer').size() > 0 ) {
			...
			$(document).on('DOMNodeInserted', function() {
				if ( $('.vc_shortcode-edit-form .wpb-edit-form').size() > 0 ) {
					...
					var $invicta_icons = $('.vc_shortcode-edit-form .wpb-edit-form .invicta_icon');
					...
					var $invicta_locations = $('.vc_shortcode-edit-form .wpb-edit-form .world_location');
					
					if ( $invicta_locations.size() > 0) {
					
						$groups = $invicta_locations.parent();
						$('.vc_shortcode-edit-form .wpb-edit-form textarea[name="label_positions"]').hide();
						...
						function update_label_positions_controller( $group ) {
							...
							var $ctr_label_positions = $('.vc_shortcode-edit-form .wpb-edit-form textarea[name="label_positions"]');
							var label_positions = '';
						...
						function init_label_positions( $group ) {
							...
							var label_positions = $('.vc_shortcode-edit-form .wpb-edit-form textarea[name="label_positions"]').val();
